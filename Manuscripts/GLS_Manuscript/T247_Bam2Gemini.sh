#!/bin/bash
#PBS -N T247_Bam2Gemini
#PBS -V
#PBS -o /mnt/causes-vnx2/TIDE/PROCESS/EXOME_TIDEX/T247/T247.o
#PBS -e /mnt/causes-vnx2/TIDE/PROCESS/EXOME_TIDEX/T247/T247.e
#PBS -m bea
...
PED_FILE=$WORKING_DIR/T247.ped
TMPDIR=${WORKING_DIR}tmpdir/
mkdir $TMPDIR
SAMPLE1_VCF=TIDEX916_BWAmem_dupremoved_realigned_HaplotypeCaller.g.vcf
SAMPLE2_VCF=TIDEX917_BWAmem_dupremoved_realigned_HaplotypeCaller.g.vcf
