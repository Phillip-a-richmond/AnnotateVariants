#!/bin/bash
#PBS -N STRAB-013_new_PrimaryPipeline
#PBS -V
#PBS -o /mnt/causes-vnx2/TIDE/PROCESS/CYNTHIA_STRAB/STRAB-013new.o
#PBS -e /mnt/causes-vnx2/TIDE/PROCESS/CYNTHIA_STRAB/STRAB-013new.e
#PBS -m bea
...
FASTQR1='/mnt/causes-vnx2/TIDE/RAW/CYNTHIA_STRAB//STRAB-013_R1.fastq.gz'
FASTQR2='/mnt/causes-vnx2/TIDE/RAW/CYNTHIA_STRAB//STRAB-013_R2.fastq.gz'
