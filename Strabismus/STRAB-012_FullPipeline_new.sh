#!/bin/bash
#PBS -N STRAB-012_new_PrimaryPipeline
#PBS -V
#PBS -o /mnt/causes-vnx2/TIDE/PROCESS/CYNTHIA_STRAB/STRAB-012new.o
#PBS -e /mnt/causes-vnx2/TIDE/PROCESS/CYNTHIA_STRAB/STRAB-012new.e
#PBS -m bea
...
FASTQR1='/mnt/causes-vnx2/TIDE/RAW/CYNTHIA_STRAB//STRAB-012_R1.fastq.gz'
FASTQR2='/mnt/causes-vnx2/TIDE/RAW/CYNTHIA_STRAB//STRAB-012_R2.fastq.gz'
