...
## CPU Usage
## 64 Gb of RAM for the whole job
#SBATCH --mem=64G
...
# Software
ANNOTVARDIR=$ANNOTATEVARIANTS_INSTALL
BCFTOOLS=bcftools
VCFANNO=vcfanno
VCF2DB=vcf2db.py
JAVA=java
...
LOFSCORESFILE=lofscoresfile
SPLICEAISNV=spliceai_snv
SPLICEAIINDEL=spliceai_indel
CACHEDIR=cache_dir
PLUGINSDIR=plugins_dir
MAXENTSCANDIR=maxentscan_dir
SLIVAR=slivar_dir
gff=gff_file
