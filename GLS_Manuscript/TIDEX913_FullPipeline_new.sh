#!/bin/bash
#PBS -N TIDEX913_new_PrimaryPipeline
#PBS -V
#PBS -o /mnt/causes-vnx2/TIDE/PROCESS/GENOME_TIDEX/T246/TIDEX913new.o
#PBS -e /mnt/causes-vnx2/TIDE/PROCESS/GENOME_TIDEX/T246/TIDEX913new.e
#PBS -m bea
...
FASTQR1='/mnt/causes-vnx2/TIDE/RAW/GENOME_TIDEX/T246/Tidex913_WGS_R1.fastq.gz'
FASTQR2='/mnt/causes-vnx2/TIDE/RAW/GENOME_TIDEX/T246/Tidex913_WGS_R2.fastq.gz'
