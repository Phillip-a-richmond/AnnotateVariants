#!/bin/bash
#PBS -N TIDEX914_new_PrimaryPipeline
#PBS -V
#PBS -o /mnt/causes-vnx2/TIDE/PROCESS/EXOME_TIDEX/T246/TIDEX914new.o
#PBS -e /mnt/causes-vnx2/TIDE/PROCESS/EXOME_TIDEX/T246/TIDEX914new.e
#PBS -m bea
...
FASTQR1='/mnt/causes-vnx2/TIDE/RAW/EXOME_TIDEX/T246/TIDEX914_1.fastq.gz'
FASTQR2='/mnt/causes-vnx2/TIDE/RAW/EXOME_TIDEX/T246/TIDEX914_2.fastq.gz'
