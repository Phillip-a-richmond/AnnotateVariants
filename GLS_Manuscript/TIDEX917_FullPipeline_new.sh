#!/bin/bash
#PBS -N TIDEX917_new_PrimaryPipeline
#PBS -V
#PBS -o /mnt/causes-vnx2/TIDE/PROCESS/EXOME_TIDEX/T247/TIDEX917new.o
#PBS -e /mnt/causes-vnx2/TIDE/PROCESS/EXOME_TIDEX/T247/TIDEX917new.e
#PBS -m bea
...
SAMPLE_ID='TIDEX917_BWAmem'
GENOME_FASTA='/mnt/causes-data01/data/GENOMES/GSC/GRCh37-lite.fa'
BWA_INDEX='/mnt/causes-data01/data/GENOMES/GSC/GRCh37-lite.fa'
CHROM='/mnt/causes-data01/data/GENOMES/GSC/SplitByChrom/'
GENOMEFILE=/mnt/causes-data01/data/GENOMES/GSC/GRCh37-lite.genome

WORKING_DIR='/mnt/causes-vnx2/TIDE/PROCESS/EXOME_TIDEX/T247/'
FASTQR1='/mnt/causes-vnx2/TIDE/RAW/EXOME_TIDEX/T247/TIDEX917_1.fastq.gz'
FASTQR2='/mnt/causes-vnx2/TIDE/RAW/EXOME_TIDEX/T247/TIDEX917_2.fastq.gz'
...
python /mnt/causes-data01/data/RICHMOND/mosdepth/scripts/plot-dist.py \
