#!/bin/bash
#PBS -N TIDEX916_new_PrimaryPipeline
#PBS -V
#PBS -o /mnt/causes-vnx2/TIDE/PROCESS/EXOME_TIDEX/T247/TIDEX916new.o
#PBS -e /mnt/causes-vnx2/TIDE/PROCESS/EXOME_TIDEX/T247/TIDEX916new.e
#PBS -m bea
...
FASTQR1='/mnt/causes-vnx2/TIDE/RAW/EXOME_TIDEX/T247/TIDEX916_1.fastq.gz'
FASTQR2='/mnt/causes-vnx2/TIDE/RAW/EXOME_TIDEX/T247/TIDEX916_2.fastq.gz'
